...
Ext.ClassManager.addNameAlternateMappings({
  ...
  "VIPSMobile.CDR": [],
  "VIPSMobile.CallFlows": [
    "CallFlows"
  ],
  "VIPSMobile.Cart": [],
  "VIPSMobile.ChangeLog": [],
  "VIPSMobile.MsgQueue": [],
  ...
  "VIPSMobile.User": [],
  "VIPSMobile.Version": [],
  "VIPSMobile.controller.Data": [],
  "VIPSMobile.controller.Groups": [],
  "VIPSMobile.controller.Library": [],
  "VIPSMobile.controller.Login": [],
  "VIPSMobile.controller.Main": [],
  "VIPSMobile.controller.Messages": [],
  "VIPSMobile.controller.Orders": [],
  "VIPSMobile.controller.Settings": [],
  "VIPSMobile.model.BrowseItem": [],
  "VIPSMobile.model.BrowsePatron": [],
  "VIPSMobile.model.CallFlowNode": [
    "CallFlowNode"
  ],
  "VIPSMobile.model.CartItem": [],
  "VIPSMobile.model.ChangeLogItem": [],
  "VIPSMobile.model.CommDistMember": [],
  "VIPSMobile.model.ConsoleLogItem": [],
  "VIPSMobile.model.DBTableItem": [],
  "VIPSMobile.model.DataMenuItem": [],
  "VIPSMobile.model.DataQueueItem": [],
  "VIPSMobile.model.IndexItem": [],
  "VIPSMobile.model.KeyValue": [],
  "VIPSMobile.model.LibraryItem": [],
  "VIPSMobile.model.MailGroup": [],
  "VIPSMobile.model.MailGroupHead": [],
  "VIPSMobile.model.Message": [
    "Message"
  ],
  "VIPSMobile.model.Shop": [],
  "VIPSMobile.model.SmartSearchItem": [],
  "VIPSMobile.store.BrowseItems": [],
  "VIPSMobile.store.BrowsePatrons": [],
  "VIPSMobile.store.CallFlowNodes": [],
  "VIPSMobile.store.ChangeLog": [],
  "VIPSMobile.store.CommDistMembers": [],
  "VIPSMobile.store.ConsoleLogItems": [],
  "VIPSMobile.store.DBTableItems": [],
  "VIPSMobile.store.DataMenu": [],
  "VIPSMobile.store.DataQueueItems": [],
  "VIPSMobile.store.IndexItems": [],
  "VIPSMobile.store.KeyValueItems": [],
  "VIPSMobile.store.LibraryItems": [],
  "VIPSMobile.store.MailGroup": [],
  "VIPSMobile.store.MailGroupHead": [],
  "VIPSMobile.store.Messages": [],
  "VIPSMobile.store.OrdersCart": [],
  "VIPSMobile.store.Shops": [],
  "VIPSMobile.store.SmartSearchItems": [],
  "VIPSMobile.util.BackgroundSync": [],
  "VIPSMobile.util.BackgroundVerCheck": [],
  "VIPSMobile.util.CallFlow": [],
  "VIPSMobile.util.Commands": [],
  "VIPSMobile.util.Console": [],
  "VIPSMobile.util.DataFunc": [
    "DataFunc"
  ],
  "VIPSMobile.util.Globals": [],
  "VIPSMobile.util.Localization": [
    "loc"
  ],
  "VIPSMobile.util.MapSymbols": [],
  "VIPSMobile.util.MegaPixImage": [],
  "VIPSMobile.util.ProfilePics": [],
  "VIPSMobile.util.SQLTable": [],
  "VIPSMobile.util.ShopOptions": [],
  "VIPSMobile.util.SyncObject": [],
  "VIPSMobile.util.VIPSOverrides": [],
  "VIPSMobile.util.Yardstick": [],
  "VIPSMobile.util.overrides.Button": [],
  "VIPSMobile.util.overrides.Component": [],
  "VIPSMobile.util.overrides.TitleBar": [],
  "VIPSMobile.util.overrides.Video": [],
  "VIPSMobile.util.overrides.app.Controller": [],
  "VIPSMobile.util.overrides.data.Connection": [],
  "VIPSMobile.util.overrides.data.Model": [],
  "VIPSMobile.util.overrides.data.Store": [],
  "VIPSMobile.util.overrides.dataview.List": [],
  "VIPSMobile.util.overrides.dataview.NestedList": [],
  "VIPSMobile.util.overrides.dataview.element.Container": [],
  "VIPSMobile.util.overrides.dom.Element": [],
  "VIPSMobile.util.overrides.field.Field": [],
  "VIPSMobile.util.overrides.field.Select": [],
  "VIPSMobile.util.overrides.form.FieldSet": [],
  "VIPSMobile.util.overrides.form.TextArea": [],
  "VIPSMobile.util.overrides.scroll.Scroller": [],
  "VIPSMobile.util.overrides.util.Geolocation": [],
  "VIPSMobile.util.overrides.util.sizemonitor.Abstract": [],
  "VIPSMobile.util.overrides.util.translatable.CssTransform": [],
  "VIPSMobile.ux.ImageInput": [],
  "VIPSMobile.ux.InfoSheet": [],
  "VIPSMobile.ux.field.Image": [],
  "VIPSMobile.ux.field.Notes": [],
  "VIPSMobile.ux.field.UOM": [],
  "VIPSMobile.ux.picker.Field": [],
  "VIPSMobile.view.Fullscreen": [],
  "VIPSMobile.view.Login": [],
  "VIPSMobile.view.Main": [],
  "VIPSMobile.view.data.CartItem": [],
  "VIPSMobile.view.data.Detail": [],
  "VIPSMobile.view.data.Empty": [],
  "VIPSMobile.view.data.Index": [],
  "VIPSMobile.view.data.Menu": [],
  "VIPSMobile.view.data.fields.BarcodeNode": [],
  "VIPSMobile.view.data.fields.CartNode": [],
  "VIPSMobile.view.data.fields.CurrencyNode": [],
  "VIPSMobile.view.data.fields.DateNode": [],
  "VIPSMobile.view.data.fields.DateNodePicker": [],
  "VIPSMobile.view.data.fields.DynamicNode": [],
  "VIPSMobile.view.data.fields.EmailTextNode": [],
  "VIPSMobile.view.data.fields.FloatNode": [],
  "VIPSMobile.view.data.fields.ImageNode": [],
  "VIPSMobile.view.data.fields.IntegerNode": [],
  "VIPSMobile.view.data.fields.LabelNode": [],
  "VIPSMobile.view.data.fields.LengthOfTimeNode": [],
  "VIPSMobile.view.data.fields.LibraryItemNode": [],
  "VIPSMobile.view.data.fields.ListNode": [
    "VIPSMobile.view.data.fields.TextListNode"
  ],
  "VIPSMobile.view.data.fields.LocationNode": [],
  "VIPSMobile.view.data.fields.MapNode": [],
  "VIPSMobile.view.data.fields.MultiLineTextNode": [],
  "VIPSMobile.view.data.fields.MultiPickListNode": [],
  "VIPSMobile.view.data.fields.PhoneTextNode": [],
  "VIPSMobile.view.data.fields.ProductDetail": [],
  "VIPSMobile.view.data.fields.SQLWebReportNode": [],
  "VIPSMobile.view.data.fields.ScanNode": [],
  "VIPSMobile.view.data.fields.Signature": [],
  "VIPSMobile.view.data.fields.TableNode": [],
  "VIPSMobile.view.data.fields.TextNode": [],
  "VIPSMobile.view.data.fields.TimeNode": [],
  "VIPSMobile.view.data.fields.TimeNodePicker": [],
  "VIPSMobile.view.data.fields.UseListItemsAsOptions": [],
  "VIPSMobile.view.data.fields.UseManualKeyEntry": [],
  "VIPSMobile.view.data.fields.table.GridNode": [],
  "VIPSMobile.view.data.fields.table.IntegerNode": [],
  "VIPSMobile.view.data.fields.table.ListNode": [],
  "VIPSMobile.view.group.Detail": [],
  "VIPSMobile.view.group.MailGroup": [],
  "VIPSMobile.view.group.Menu": [],
  "VIPSMobile.view.library.Detail": [],
  "VIPSMobile.view.library.Menu": [],
  "VIPSMobile.view.messages.Compose": [],
  "VIPSMobile.view.messages.Detail": [],
  "VIPSMobile.view.messages.Menu": [],
  "VIPSMobile.view.messages.SortSheet": [],
  "VIPSMobile.view.orders.Browse": [],
  "VIPSMobile.view.orders.Cart": [],
  "VIPSMobile.view.orders.Container": [],
  "VIPSMobile.view.orders.Detail": [],
  "VIPSMobile.view.orders.Patrons": [],
  "VIPSMobile.view.orders.PlaceOrder": [],
  "VIPSMobile.view.orders.Shops": [],
  "VIPSMobile.view.settings.ChangeLog": [],
  "VIPSMobile.view.settings.ConsoleLog": [],
  "VIPSMobile.view.settings.DBTables": [],
  "VIPSMobile.view.settings.DataQueue": [],
  "VIPSMobile.view.settings.Location": [],
  "VIPSMobile.view.settings.Overview": [],
  "VIPSMobile.view.settings.Profile": []
});
...
Ext.ClassManager.addNameAliasMappings({
  ...
  "VIPSMobile.view.data.fields.IntegerNode": [],
  "VIPSMobile.view.data.fields.LabelNode": [
    "VIPSMobile.view.data.fields.LableNode"
  ],
  "VIPSMobile.view.data.fields.LengthOfTimeNode": [],
  "VIPSMobile.view.data.fields.LibraryItemNode": [],
  "VIPSMobile.view.data.fields.ListNode": [
