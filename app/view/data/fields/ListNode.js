...
Ext.define('VIPSMobile.view.data.fields.ListNode', {
    extend: 'VIPSMobile.view.data.Detail',
    alias: ['VIPSMobile.view.data.fields.TextListNode'],
    alternateClassName: ['VIPSMobile.view.data.fields.TextListNode'], 
    ...
    getValue: function () {
        ...
        comment = this.down('commentsField');

        if (this.getCommentsField()) {
            this.getNode().set('commentsField', {
                field: this.getCommentsField().getData().fieldName,
                value: this.getCommentsField().getValue(),
            });
            console.log('comment', this.getCommentsField(), this.getNode());
        }
    ...
    scrollToValue: function () {
        ...
        try {
            ...
            console.error('ListNode.scrollToValue() Error', ex.message);
        }
