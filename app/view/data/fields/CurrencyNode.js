...
Ext.define('VIPSMobile.view.data.fields.CurrencyNode', {
    ...
    getValue: function () {
        var curValue = this.getField().getValue();
    ...
    setValue: function (value) {
        ...
        if (Ext.isNumeric(value)) {
            ...
            if (parsedValue === value) {
                value = (parsedValue % 1) ? parsedValue.toFixed(2).toString() : parsedValue.toString();
            }
        } else if (value == '.') {
